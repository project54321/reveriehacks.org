...
const judges: Judge[] = [
  ...
  { name: 'Sunil Kumar', role: 'Principal Agile Practitioner', company: 'Bank of America', img: '/judges/sunil.png', track: 'Ideathon', linkedin: 'www.linkedin.com/in/sunil-Kumars'},
