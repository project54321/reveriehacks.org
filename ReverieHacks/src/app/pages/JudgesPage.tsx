...
const judges: Judge[] = [
  ...
  { name: 'Mayur Jain', role: 'Senior Software Engineer', company: 'Bridgestone Americas', img: '/judges/mayur.png', track: 'Software Development' },
  ...
  { name: 'Anisha Yarlapati', role: 'Product Manager', company: 'Adobe', img: '/judges/anisha.png', track: 'Ideathon' },
  { name: 'Hung Truong', role: 'Incoming Software Engineer', company: 'HubSpot', img: '/judges/hung.png', track: 'App Development' },
  { name: 'Udaya Bhaskar Vemuri', role: 'Application Security & DevSecOps', img: '/judges/udaya.png', track: 'Software Development' },
  { name: 'Frank Chu', img: '/judges/frank.png', track: 'ML Prompt Engineering' },
];
