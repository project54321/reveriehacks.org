...
const DriftWall = ({
  ...
  const effectiveOverlay = theme === 'light' ? 'color-mix(in srgb, var(--primary) 8%, var(--card))' : overlayColor;
  ...
  const cssVars = useMemo<CSSProperties>(
    ...
    [tileWidth, tileHeight, gap, radius, lift, dim, grayscale, effectiveOverlay, fade, perspective, maskStyle, style]
  );
  ...
  const innerClass = cx(
    'pointer-events-none absolute inset-[calc(var(--dw-gap)/2)] block overflow-hidden bg-card border border-border',
